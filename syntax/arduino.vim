...
syn keyword arduinoConstant BIN CHANGE DEC DEFAULT EXTERNAL FALLING
HALF_PI HEX
syn keyword arduinoConstant HIGH INPUT INPUT_PULLUP INTERNAL
INTERNAL1V1
syn keyword arduinoConstant INTERNAL2V56 LOW LSBFIRST MSBFIRST OCT
OUTPUT PI
...
syn keyword arduinoFunc bitWrite delay delayMicroseconds
detachInterrupt
syn keyword arduinoFunc digitalRead digitalWrite highByte interrupts
syn keyword arduinoFunc lowByte micros millis noInterrupts noTone
pinMode
syn keyword arduinoFunc pulseIn shiftIn shiftOut tone

syn keyword arduinoMethod available begin end find findUntil flush
loop
syn keyword arduinoMethod parseFloat parseInt peek print println
read
...
cos degrees
syn keyword arduinoStdFunc exp floor log map max min radians random
randomSeed
